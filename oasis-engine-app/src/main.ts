...
function fitWithHeight(aspectRatio: number) {
  ...
  const parentEle = canvas.parentElement as HTMLElement;
...
engine.resourceManager
  .load([
    ...
    {
      // Ground.
      url: "A_Sj7OS4YJHDIAAAAAAAAAAAAAARQnAQ.png",
      type: AssetType.Texture2D
    },
    {
      // Bird.
  ...
  .then((texture2DArr: Texture2D[]) => {
    ...
    nodeBg.addComponent(SpriteRenderer).sprite = new Sprite(engine, texture2DArr[0], undefined, undefined, 100);
    ...
    nodeBird.addComponent(SpriteRenderer).sprite = new Sprite(engine, texture2DArr[3], undefined, undefined, 100);
    ...
    nodeRestart.addComponent(SpriteRenderer).sprite = new Sprite(engine, texture2DArr[4], undefined, undefined, 100);
    // Score.
...
class ScriptPipe extends Script {
  ...
  onAwake() {
    ...
    node1.addComponent(SpriteRenderer).sprite = new Sprite(engine, gameResArray[1], undefined, undefined, 100);
    node2.addComponent(SpriteRenderer).sprite = new Sprite(engine, gameResArray[1], undefined, undefined, 100);
...
class ScriptScore extends Script {
  ...
  onAwake() {
    ...
    for (var i = 0; i < 10; i++) {
      spriteArray.push(new Sprite(engine, gameResArray[5], new Rect(i * 0.1, 0, 0.1, 1), undefined, 75));
    }
...
class ScriptBird extends Script {
  ...
  private _initDataAndUI() {
    ...
    renderer.sprite = this._sprite = new Sprite(engine, gameResArray[3], undefined, undefined, 100);
    this._setFrameIndex(0);
  }
